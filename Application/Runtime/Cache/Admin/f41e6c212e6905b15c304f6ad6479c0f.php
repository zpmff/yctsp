...
<button type="button" tooltip="添加管理员" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '/yctsp/index.php/Admin/Order/add'"> <i class="fa fa-plus"></i> 添加订单</button>
...
<div class="row">
 ...
 $arr = explode(',',$vo[path]); $size = count($arr); ?>
                                    ...
                                    <?php if($size < 3 ): ?><a href="/yctsp/index.php/Admin/Order/addZilei/pid/<?php echo ($vo["id"]); ?>/path/<?php echo ($vo["path"]); ?>" class="btn btn-primary btn-sm shiny">
                                ...
                                <td align="center">
                                    ...
                                    <a href="#" onClick="warning('确实要删除吗', '/yctsp/index.php/Admin/Order/delete/id/<?php echo ($vo["id"]); ?>')" class="btn btn-danger btn-sm shiny">
