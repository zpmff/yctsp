                                ...
                                <div id="horizontal-form">
                                    ...
                                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label for="osid" class="col-sm-2 control-label no-padding-right">订单状态</label>
                                            <div class="col-sm-6">
                                                <select name="osid" id="osid">
                                                    <?php if(is_array($order_statuses)): $i = 0; $__LIST__ = $order_statuses;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"    <?php if($vo[id] == $orderesa[osid] ): ?>selected<?php endif; ?>  ><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                                </select>
                                            </div>
                                        ...
                                        <input type="hidden" name="id" value="<?php echo ($orderesa["id"]); ?>">
