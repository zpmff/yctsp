...
class UserModel extends Model {
    ...
    protected $_validate = array(
        array('name','require','用户名不能为空',0,'regex',3), //在新增和修改的时候，都必须验证name 必须存在
        array('name','','用户名已经存在！',0,'unique',3), // 在新增的时候验证name字段是否唯一
        array('name','3,12','用户名长度为3-12位字符！',0,'length',3), // 在新增的时候验证name字段是否唯一
